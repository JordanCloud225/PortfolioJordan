<template>
    ...
    <!-- Title -->
     <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-secondary stroke-text text-stroke-primary dark:text-stroke-secondary" data-aos="fade-up" >
        {{ title }}
     </h2>
</template>
<script setup> 
